...
SCHEMA_PATH = Path('/home/leticia/Documentos/uefs/24.2/passcom/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/leticia/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(SyncBasePrisma):
    ...
    trecho: 'actions.TrechoActions[models.Trecho]'
    assento: 'actions.AssentoActions[models.Assento]'
    trechoreservado: 'actions.TrechoReservadoActions[models.TrechoReservado]'
    passagem: 'actions.PassagemActions[models.Passagem]'
    ...
    def __init__(
        ...
        *,
        ...
        self.trecho = actions.TrechoActions[models.Trecho](self, models.Trecho)
        self.assento = actions.AssentoActions[models.Assento](self, models.Assento)
        self.trechoreservado = actions.TrechoReservadoActions[models.TrechoReservado](self, models.TrechoReservado)
        self.passagem = actions.PassagemActions[models.Passagem](self, models.Passagem)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/leticia/Documentos/uefs/24.2/passcom/prisma/schema.prisma',
        }
...
class Batch:
    trecho: 'TrechoBatchActions'
    assento: 'AssentoBatchActions'
    trechoreservado: 'TrechoReservadoBatchActions'
    passagem: 'PassagemBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.trecho = TrechoBatchActions(self)
        self.assento = AssentoBatchActions(self)
        self.trechoreservado = TrechoReservadoBatchActions(self)
        self.passagem = PassagemBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class TrechoReservadoBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
