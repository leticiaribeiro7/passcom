...
class TrechoActions(Generic[_PrismaModelT]):
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Trecho record ordered by the company field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Trecho records by id values
...
class AssentoActions(Generic[_PrismaModelT]):
    ...
    def create(
        ...
        assento = Assento.prisma().create(
            data={
                ...
                'numero': 1675546029,
                'id_trecho': 1767274722,
                'disponivel': 326272115,
            },
        )
        ```
        """
            ...
            data=[
                {
                    ...
                    'numero': 1343201072,
                    'id_trecho': 675780521,
                    'disponivel': 744964398,
                },
                {
                    # data to create a Assento record
                    'numero': 1969681615,
                    'id_trecho': 1116175964,
                    'disponivel': 861472101,
                },
            ],
            skip_duplicates=True,
        )
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second Assento record ordered by the disponivel field
    ...
    def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Assento records by id values
        # and count how many records are in each group
        ...
        *,
        ...
        total = TrechoReservado.prisma().create_many(
            data=[
                {
                    # data to create a TrechoReservado record
                    'uuid_passagem': 'bhhfibbigf',
                    'id_trecho': 893145566,
                    'id_assento': 995405759,
                },
                {
                    # data to create a TrechoReservado record
                    'uuid_passagem': 'cbachdgfce',
                    'id_trecho': 271520213,
                    'id_assento': 456633834,
                },
            ],
            skip_duplicates=True,
        )
...
class PassagemActions(Generic[_PrismaModelT]):
    ...
    def query_first(
        ...
        *args
        ...
        user = Passagem.prisma().query_first(
            'SELECT * FROM Passagem WHERE user_uuid = $1',
            'gieegcbeg',
        )
        ```
        """
    ...
    def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Passagem record ordered by the user_uuid field
...
class UserActions(Generic[_PrismaModelT]):
    ...
    def find_first(
        ...
        -------
        ```py
        # find the second User record ordered by the uuid field
    ...
    def find_first_or_raise(
        ...
        -------
        ```py
        # find the second User record ordered by the login field
